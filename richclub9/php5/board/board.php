...
<?php
    ...
    //데이터 불러오기(JOIN)
    $sql = "SELECT b.boardID, b.boardTitle, m.youName, b.regTime, b.boardView FROM andBoard b JOIN andMember m ON (b.memberID = m.memberID) ORDER BY boardID DESC LIMIT {$viewLimit}, {$viewNum}";
...
<?php
    //전체 갯수
    $sql = "SELECT count(boardID) FROM andBoard";
    $result = $connect -> query($sql);
