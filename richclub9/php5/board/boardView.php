...
<?php
    ...
    $sql = "SELECT b.boardTitle, m.youName, b.regTime, b.boardView, b.boardContent FROM andBoard b JOIN andMember m ON(b.memberID = m.memberID) WHERE b.boardID = {$boardID}";
    ...
    if( $result ){
        ...
        echo "<tr><th>내용</th><td class='height left'>".$info['boardContent']."</td></tr>";
    }
?>
                                <!-- <tr>
                                    <th>제목</th>
                    ...
                    <div class="board-btn right mb50">
                        ...
                        <a href="boardRemove.php?boardID=<?=$_GET['boardID']?>" onclick="confirm('정말 삭제하기겠습니까?','')"/>삭제하기</a>
