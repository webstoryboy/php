...
<?php 
    ...
    $sql = "SELECT b.boardTitle, m.youName, b.regTime, b.boardView, b.boardContent FROM webBoard b JOIN webMember m ON(b.memberID = m.memberID) WHERE b.boardID = {$boardID}";
