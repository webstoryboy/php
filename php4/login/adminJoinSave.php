...
<body>
    ...
    <?php
        ...
        //회원가입
        $sql = "INSERT INTO webAdmin(youEmail, youNickName, youPass, youName, youBirth, youPhone, regTime) VALUES('$youEmail', '$youNickName', '$youPass', '$youName', '$youBirth', '$youPhone', '$regTime')";
        $result = $connect -> query($sql);

        if($result){
            msg("회원가입을 축하합니다. 로그인을 해주세요!");
            echo "<script>alert('회원가입을 축하합니다. 로그인을 해주세요!'); location.href='adminLogin.php'</script>";
