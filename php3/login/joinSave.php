...
<?php
    ...
    $sql = "SELECT youEmail FROM hwangMember WHERE youEmail = '$youEmail'";
    $result = $connect -> query($sql);
    ...
    $sql = "SELECT youPhone FROM hwangMember WHERE youPhone = '$youPhone'";
    $result = $connect -> query($sql);
    ...
    if($isEmailCheck == true && $isPhoneCheck = true){
        $sql = "INSERT INTO hwangMember(youEmail, youPass, youName, youBirth, youPhone, regTime) VALUES('$youEmail', '$youPass', '$youName', '$youBirth', '$youPhone', '$regTime')";
        $result = $connect -> query($sql);
