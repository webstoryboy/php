                ...
                <article class="content-article">
                    ...
                    <div class="board">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    //board + member
                                    $sql = "SELECT b.boardID, b.boardTitle, m.youName, b.boardView, b.regTime FROM myBoard99 b JOIN myMember99 m ON (m.memberID = b.memberID) ORDER BY boardID DESC LIMIT {$viewLimit}, {$numView}";
                        ...
                        <div class="page">
                            <ul>
                                <?php
                                    $sql = "SELECT count(boardID) FROM myBoard99";
                                    $result = $connect -> query($sql);
